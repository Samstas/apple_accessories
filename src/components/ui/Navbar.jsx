      ...
      <ul className="flex items-center gap-2">
        <li>
          <Link to="cart" className="relative">
            ...
            {cartQuantity ? (
              <div className=" absolute h-5 w-5 overflow-hidden  rounded-full bg-orange-400 p-[1px] text-center text-[12px] font-bold text-zinc-800 firefox:-right-[2rem] firefox:top-[0.75rem] safari:-right-5 safari:-top-6  chrome:-right-2 chrome:-top-1">
                {cartQuantity}
              </div>
            ) : null}
          </Link>
